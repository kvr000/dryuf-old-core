...
public class NaturalTextualTest extends TextualsTestBase<java.lang.Integer>
{
	public NaturalTextualTest()
	{
		super(net.dryuf.textual.NaturalTextual.class);
	}
	...
	public void			testCorrect() throws Exception
	{
		...
		Assert.assertEquals(123456, (long)textual.convert("123456", null));
	}

	@Test
	public void			testFormat()
	{
		Assert.assertEquals("123456", textual.format(123456, null));
	}
