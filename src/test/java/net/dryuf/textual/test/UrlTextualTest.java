...
public class UrlTextualTest extends TextualsTestBase<java.lang.String>
{
	public UrlTextualTest()
	{
		super(net.dryuf.textual.UrlTextual.class);
	}
	...
	{
		textual.convert("http://kvr.znj.c z/drt/", null);
	}
}
