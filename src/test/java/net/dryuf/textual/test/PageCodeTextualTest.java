...
public class PageCodeTextualTest extends TextualsTestBase<java.lang.String>
{
	public PageCodeTextualTest()
	{
		super(net.dryuf.textual.PageCodeTextual.class);
	}
	...
	public void			testCorrect() throws Exception
	{
		...
		Assert.assertNotNull(textual.check("hello ", null));
		Assert.assertNotNull(textual.check("hello/world", null));
		Assert.assertEquals("hello", textual.convert("hello", null));
	}
