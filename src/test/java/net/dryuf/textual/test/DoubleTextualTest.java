...
public class DoubleTextualTest extends TextualsTestBase<java.lang.Double>
{
	public DoubleTextualTest()
	{
		super(net.dryuf.textual.DoubleTextual.class);
	}
	...
	public void			testCorrect() throws Exception
	{
		...
		Assert.assertNotNull(textual.check("123..456", null));
		Assert.assertNotNull(textual.check(".123.456", null));
		Assert.assertEquals(123.456, textual.convert("123.456", null), 0.1);
	}
