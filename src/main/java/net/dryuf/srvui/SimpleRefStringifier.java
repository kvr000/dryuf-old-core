...
public class SimpleRefStringifier extends java.lang.Object implements RefStringifier
{
	public				SimpleRefStringifier(PageContext pageContext)
	{
	...
	public String			stringifyRef(PageUrl ref)
	{
		...
		case PageUrl.TYPE_PAGED:
			return this.pageContext.getContextPath()+"/"+(url.length() != 0 ? url+"/" : "");
