...
@Transactional("dryuf")
public class DryufComposDaoContext<ET, PKT, COMPOSPK> extends DryufDaoContext<ET, PKT> implements DynamicComposDao<ET, PKT, COMPOSPK>
{
	public				DryufComposDaoContext(Class<ET> entityClass)
	{
		super(entityClass);
	}
