...
public interface DynamicComposDao<ET, PKT, COMPOSPK> extends DynamicDao<ET, PKT>
{
	...
	public List<ET>			listByCompos(COMPOSPK compos);
	public long			removeByCompos(COMPOSPK compos);
