...
public class TimeIntervalDayedTextual extends FormatOnlyTextual<Long>
{
	public String			format(java.lang.Long internal_, String style)
	{
		...
		internal = internal/60;
		long hour = internal%24;
		long days = internal/24;
		return String.format("%dd %02d:%02d:%02d", days, hour, min, sec);
	}
}
