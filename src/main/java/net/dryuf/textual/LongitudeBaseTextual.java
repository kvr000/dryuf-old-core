...
public class LongitudeBaseTextual extends DirectKeyPreTrimTextual<Integer>
{
	...
	public String			validateDouble(java.lang.Double value)
	{
		if (value < -1800000000 || value > 1800000000)
			return getUiContext().localize(LongitudeTextual.class, "Longitude must be within interval -180 - 180");
		return null;
	}
